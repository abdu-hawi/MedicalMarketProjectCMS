...
?>
  <tr>
                ...
                <td class="text-left parentItem" id="<?php echo $items['id']; ?>">
                	<?php echo $items['name']; ?>
                </td>
                <td class="text-center parentItem" id="<?php echo $items['id']; ?>">
...
// This code for open invoice detail on click row list_detail
$(document).on('click','.parentItem',function(){
    var id_ord = $(this).attr("id");
	$.ajax({
        url:'includeOP/item_detail.php',
        type:'POST',
        data:'idItem='+id_ord,
