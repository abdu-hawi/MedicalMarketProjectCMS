  ...
  <form class="form-horizontal med_mat" id="add_mat" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10 col-lg-3">
        <input type="text" class="form-control" id="com_id" placeholder="Write Company ID" name="companyID" 
        	oninput="comFunction()">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10 col-lg-6" id="com_name_test">
        <input type="text" class="form-control" id="com_name" value="" name="company" readonly>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10 col-lg-5">
        <input type="text" class="form-control" id="mat_name" placeholder="Write Name of Material" name="matName"
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10 col-lg-8">
        <textarea class="form-control" id="mat_desc" placeholder="Write Details of Material" name="matDesc"
         	oninput="matFunction()" rows="8"></textarea>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10 col-lg-3">
        <input  type="text" class="form-control" id="pruch_pri" name="pruchPri" placeholder="Write Purchasing Price"
        	oninput="pruchFunction()">
      </div>
      <label class="control-label col-sm-2" for="selPri">Selling Price:</label>
      <div class="col-sm-10 col-lg-3">
        <input  type="text" class="form-control" id="sel_pri" placeholder="Write Selling Price" name="selPri"
        	oninput="selFunction()">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10 col-lg-3">
        <input type="text" class="form-control" id="amt_stk" placeholder="Write Amount of Stock" name="amtStk"
         	oninput="amtStkFunction()"/>
      </div>
      <label class="control-label col-sm-2" for="unitMat">Unit of Material:</label>
      <div class="col-sm-10 col-lg-3">
        <input  type="text" class="form-control" id="unit_mat" placeholder="Write Unit of Material" name="unitMat"
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10 col-lg-3">
        <input  type="date" class="form-control" id="prod_date" placeholder="Write Product Date" name="prodDate"
        	oninput="prodDateFunction()">
      </div>
      <label class="control-label col-sm-2" for="expDate">Expire Date:</label>
      <div class="col-sm-10 col-lg-3">
        <input  type="date" class="form-control" id="exp_date" placeholder="Write Expire Date" name="expDate"
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10 col-lg-3">
        <input type="text" class="form-control" id="mat_code" placeholder="Write Code Of Material" name="matCode"
    ...
    <!--
    <div class="form-group">
      <label class="control-label col-sm-2" for="matImg">Picture Of Material:</label>
      <div class="col-sm-10 col-lg-3">
        <input type="file" class="form-control" id="mat_img" name="matImg" onChange="matImgFunction()">
      </div>
      <div id="show_img"></div>
    </div>
    -->
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <Button type="button" class="btn btn-success add_supplay" id="add_supplay" name="add_supplay">Click To Continue Add Material</button>
      </div>
    </div>
  </form>
...
function addForm(){
	...
	$.post('includeOP/add_mat_op.php',da_form,function(data){
		//okInsert value is coming from post.add.php if is true insert to db
		data = $.parseJSON( data );
		if(data.msg == 'ok'){
			//location.replace('img_up.php?id='+data.id);
